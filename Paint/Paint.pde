...
void mouseReleased () { //--------------------------------
  ...
  if (icon2On == true) {
    if (mouseX > 490 && mouseX < 530 && mouseY > 485 && mouseY < 525) {
      image(icon2, mouseX, mouseY, thickness+80, thickness+80);
    }
  }
  ...
  //  image(icon3, mouseX, mouseY, thickness+80, thickness+80);
  //}

  //if (mouseX > 590 && mouseX < 630 && mouseY > 485 && mouseY < 525) {
  //  image(icon4, mouseX, mouseY, thickness+80, thickness+80);
  //}
